...
public interface CasesApi {
  ...
  @ApiResponses(value = {@ApiResponse(code = 204, message = "Pause removed")})
  ...
  @ApiResponses(value = {@ApiResponse(code = 200, message = "Pause returned", response = CasePause.class)})
  ...
  @ApiResponses(value = {@ApiResponse(code = 200, message = "Pause created or updated.", response = CasePause.class)})
