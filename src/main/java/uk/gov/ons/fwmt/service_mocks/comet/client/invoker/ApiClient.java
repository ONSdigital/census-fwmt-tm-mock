package uk.gov.ons.fwmt.service_mocks.comet.client.invoker;
...
import uk.gov.ons.fwmt.service_mocks.comet.client.invoker.auth.ApiKeyAuth;
import uk.gov.ons.fwmt.service_mocks.comet.client.invoker.auth.Authentication;
import uk.gov.ons.fwmt.service_mocks.comet.client.invoker.auth.HttpBasicAuth;
import uk.gov.ons.fwmt.service_mocks.comet.client.invoker.auth.OAuth;
...
public class ApiClient {
  ...
  private String basePath = "https://dev-ons-comet.client.api.azure-comet.client.api.net/comet/v1";
  ...
  protected void init() {
    ...
    authentications.put("oauth2ons-dev-web-app-oauth2-service", new OAuth());
